...
from .views import ReportsView, update_stat
...
urlpatterns = [
    ...
    url(r'^advanced/europe$', ReportsView.as_view(), name='advanced_europe'),
    url(r'^advanced/(?P<country>\d+)$', ReportsView.as_view(), name='advanced_country'),
    url(r'^basic/europe$', ReportsView.as_view(), name='basic_europe'),
