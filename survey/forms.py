...
from .models import Response, Survey, Organization
...
class StartForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if len(region_choices):
            ...
            self.fields["region"] = forms.ChoiceField(choices=region_choices, required=True, widget=forms.RadioSelect)
        else:
        ...
        if survey_choices_len > 1:
            ...
            self.fields["survey"] = forms.ChoiceField(choices=survey_choices, widget=forms.RadioSelect)
